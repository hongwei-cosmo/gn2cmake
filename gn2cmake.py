...
def WriteProject(project):
  ...
  out.write('list(APPEND CMAKE_PREFIX_PATH "C:/Program Files (x86)/Windows Kits/10/Lib/10.0.17134.0/um/x64")\n')
  out.write('list(APPEND CMAKE_PREFIX_PATH "C:/Program Files (x86)/Microsoft Visual Studio/2017/Community/VC/Tools/MSVC/14.15.26726/lib/x64")\n')
